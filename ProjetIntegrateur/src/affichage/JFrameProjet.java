...
public class JFrameProjet extends javax.swing.JFrame{
    
    ControlleurFrame cf;
    
    public JFrameProjet(ControlleurFrame cf) {
        this.cf = cf;
        initComponents();
        setVisible(true);
    }
    ...
    private void BoutonResistanceActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        cf.BoutonResistance(evt);
    }                                                

    private void BoutonParalleleActionPerformed(java.awt.event.ActionEvent evt) {                                                
